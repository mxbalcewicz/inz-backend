...
router.register(r'students', StudentDocumentView, basename='student_document_view')
...
router.register(r'semester', SemesterDocumentView, basename='semester_document_view')
